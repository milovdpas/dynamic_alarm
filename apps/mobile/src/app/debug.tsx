        ...
        <ThemedView style={styles.flex}>
            <SafeAreaView style={styles.flex} edges={['bottom']}>
                <ScrollView contentContainerStyle={styles.content}>
                    ...
                    {/*
                     * Which JavaScript is running, which an over-the-air update
                     * makes a real question: the APK is from one day and its
                     * bundle may be from another, and nothing else on the phone
                     * says so.
                     */}
                    <Section title={t('bundle.title')}>
                        ...
                        {bundle !== null && (
                            <>
                                ...
                                />
                                {/*
                                 * The full id, not a prefix: it is compared
                                 * against what `eas update` printed, and half of
                                 * a uuid cannot be compared with anything.
                                 */}
                                <DetailRow
